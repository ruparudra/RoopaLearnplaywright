...
test('test', async ({ page }) => {
  ...
  await page.getByRole('textbox').nth(1).fill(addjobtitle + randomchars);
  await page.getByRole('textbox', { name: 'Type description here' }).click();
  await page.getByRole('textbox', { name: 'Type description here' }).fill('automation script');
  await page.getByRole('textbox', { name: 'Add note' }).click();
  await page.getByRole('textbox', { name: 'Add note' }).fill('write automation script');
